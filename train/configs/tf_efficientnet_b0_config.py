...
tf_efficientnet_b0_config = Config(
    ...
    dataset_config=DatasetConfig(batch_size=16,
                                 ...
                                 train_path=project_dir+ "/data/processed/cat_individual_database.csv",
                                 val_path=project_dir +  "/data/processed/cat_individual_database.csv"),
    model_config=ModelConfig(model_name="tf_efficientnet_b0",
                             embedding_size=512, num_classes=509,
                             path_to_save=project_dir + "/models", resume_checkpoint="",
